...
function onOfficeChanged() {
	...
	if (($("#officeWorkingTimeFrom").val() + $("#officeWorkingTimeTo").val()).trim() == "") {
		workTime = "";
	} else {
		workTime =  $("#officeWorkingTimeFrom").val() + " - " + $("#officeWorkingTimeTo").val();
	}
	$("#varOfficeWorkingTime").text(workTime);
	if (($("#officeWorkingTimeHalfFrom").val() + $("#officeWorkingTimeHalfTo").val()).trim() == "") {
		workTime = "";
	} else {
...
function setQuarterName(quarterName, initAfterFormChangeFlag) {
	$( "#quarterName" ).val(quarterName != null ? quarterName.trim().toUpperCase() : "");
	if (initAfterFormChangeFlag) {
		initAfterFormChange();
	}
	onQuarterNameChanged();
...
function setQuarter(item, initAfterFormChangeFlag) {
	...
	if (item == null) {
		...
		$( "#quarterActualName" ).val(item.actualName != null ? item.actualName.trim().toUpperCase() : "");
	}
	if (initAfterFormChangeFlag) {
		initAfterFormChange();
	}
